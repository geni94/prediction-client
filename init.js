const color_list = ['#c23531','#2f4554', '#61a0a8', '#d48265', '#91c7ae','#749f83',  '#ca8622', '#bda29a','#6e7074', '#546570', '#c4ccd3'];
const colors = ['#5793f3', '#d14a61', '#675bba','#b62f46'];
...
$('#suggestbutton').click(function () {
  // Assign suggested values for initial ANN configuration
...
$('#trainbutton').click(function() {
  ...
  setTimeout(function () {
    ...
    async_training_loop(function() {
      ...
      $('#loading').fadeOut(50);
      Materialize.toast('Training is concluded!', 2000)
